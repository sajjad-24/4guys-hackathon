...
<body>
    ...
    <div class="container col-12 m-5">
      ...
      if(isset($_POST['btn_img']))
      {
        ...
        $filename = $_FILES["choosefile"]["file"];
        $tempfile = $_FILES["choosefile"]["tmp_name"];
        $folder = "image/".$filename;
        $sql = "INSERT INTO `ass`(`files`)VALUES('$filename')";
        if($filename == "")
        {
            echo 
            "s
            ...
            <div class='alert alert-success' role='alert'>
                <h4 class='text-center'>Document uploaded</h4>
            </div>
            ";
        }
      }
        ...
        <table class="table text-center">
            ...
            <?php
            $conn = mysqli_connect("localhost","root","","hackoverflow");
            ...
            while($fetch = mysqli_fetch_assoc($result2))
            {
                ...
                <tr>
                    ...
                    <td><a href="./image/<?php echo $fetch['image'] ?>">view</a></td>
